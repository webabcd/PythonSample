...
print(f'{k=}') # k='abc'
# 保留 2 位小数，四舍五入
print(f"{123.456789:.2f}") # 123.46
# 保留 2 位小数，四舍五入，显示的字符串最少 8 个字符，不够的左侧补 x
print(f"{123.456789:x>8.2f}") # xx123.46
# 保留 2 位小数，四舍五入，显示的字符串最少 8 个字符，不够的右侧补 x
print(f"{123.456789:x<8.2f}") # 123.46xx